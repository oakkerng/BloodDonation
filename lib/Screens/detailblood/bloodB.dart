...
class BloodB extends StatefulWidget {

  @override
  _BloodB createState() => _BloodB();
}

class _BloodB extends State<BloodB> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Bသွေးစာ၇င်း')),
      body: Container(
        height: double.infinity,
        child: FirebaseAnimatedList(
          query: _ref.orderByChild('bloodType').equalTo('B'),
