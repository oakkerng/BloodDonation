...
class BloodO extends StatefulWidget {

  @override
  _BloodO createState() => _BloodO();
}

class _BloodO extends State<BloodO> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Oသွေးစာ၇င်း')),
      body: Container(
        height: double.infinity,
        child: FirebaseAnimatedList(
          query: _ref.orderByChild('bloodType').equalTo('O'),
