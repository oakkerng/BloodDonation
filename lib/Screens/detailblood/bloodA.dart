...
class BloodA extends StatefulWidget {

  @override
  _BloodA createState() => _BloodA();
}

class _BloodA extends State<BloodA> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Aသွေးစာ၇င်း')),
      body: Container(
        height: double.infinity,
        child: FirebaseAnimatedList(
          query: _ref.orderByChild('bloodType').equalTo('A'),
