...
class BloodAm extends StatefulWidget {

  @override
  _BloodAm createState() => _BloodAm();
}

class _BloodAm extends State<BloodAm> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Amသွေးစာ၇င်း')),
      body: Container(
        height: double.infinity,
        child: FirebaseAnimatedList(
          query: _ref.orderByChild('bloodType').equalTo('Am'),
