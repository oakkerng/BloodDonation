...
class BloodAB extends StatefulWidget {

  @override
  _BloodAB createState() => _BloodAB();
}

class _BloodAB extends State<BloodAB> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('ABသွေးစာ၇င်း')),
      body: Container(
        height: double.infinity,
        child: FirebaseAnimatedList(
          query: _ref.orderByChild('bloodType').equalTo('AB'),
