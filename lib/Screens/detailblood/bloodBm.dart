...
class BloodBm extends StatefulWidget {

  @override
  _BloodBm createState() => _BloodBm();
}

class _BloodBm extends State<BloodBm> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Bmသွေးစာ၇င်း')),
      body: Container(
        height: double.infinity,
        child: FirebaseAnimatedList(
          query: _ref.orderByChild('bloodType').equalTo('Bm'),
